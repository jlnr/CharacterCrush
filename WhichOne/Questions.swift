...
let hanziDefinitions: [Character: HanziDefinition] = {
    ...
    definitions["網"] = HanziDefinition(pinyin: "tbd",    translation: "tbd")
    definitions["綱"] = HanziDefinition(pinyin: "tbd",    translation: "tbd")
    ...
    // more: 遨邀 繁擊 摧攜 船般 殼穀 消減 消滅 消費 寻导 捨拾 繼斷 徵徽...
